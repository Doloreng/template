...
-(UIImage*)cropWithRatio:(CGFloat)CropRatio{
    ...
    CGFloat bounds_size;
    if(width>=height){
        bounds_size=0.9*height;
        
    }else {
        bounds_size=0.9*width;
    }
    
    CGImageRef finalImgRef=CGImageCreateWithImageInRect(imgRef,CGRectMake((width-bounds_size*CropRatio)/2, (height-bounds_size)/2, bounds_size*CropRatio, bounds_size));
